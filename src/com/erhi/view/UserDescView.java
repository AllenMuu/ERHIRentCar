...
public class UserDescView {
	...
	public  UserDescView(User user){
		
		jf = new JFrame("二嗨租车--用户降序查询");
		back = new JButton("返回");
        ...
        DefaultTableModel tableModel=new DefaultTableModel(queryData(),head){
			 ...
			 * 
			 */
			private static final long serialVersionUID = 3204067051500002314L;
	...
	public Object[][] queryData(){
        ...
        List<Car> list=mICarBizimpl.searchDesc();
