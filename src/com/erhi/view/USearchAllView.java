...
public class USearchAllView {
	...
	public USearchAllView(User user) {
		mICarBizimpl = new CarBizImpl();
		jf = new JFrame("二嗨租车--全部查询");
		back = new JButton("返回");
        ...
        DefaultTableModel tableModel=new DefaultTableModel(queryData(),head){
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6080401216308644322L;
	...
	public Object[][] queryData(){
		mICarBizimpl = new CarBizImpl();
        List<UserCar> list=mICarBizimpl.searchAll();
