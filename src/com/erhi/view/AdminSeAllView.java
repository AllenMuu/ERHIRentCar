...
public class AdminSeAllView {
	...
	public  AdminSeAllView(){
		mICarBizimpl = new CarBizImpl();
		jf = new JFrame("二嗨租车--管理员全部查询");
		back = new JButton("返回");
        ...
        head=new String[] {
            "汽车编号", "汽车名称", "排量", "品牌", "类型", "单价", "是否可租","是否上架"
        };
        ...
        DefaultTableModel tableModel=new DefaultTableModel(queryData(),head){
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6330575550353783765L;
	...
	public Object[][] queryData(){
		mICarBizimpl = new CarBizImpl();
        List<Car> list=mICarBizimpl.searchAdmin();
